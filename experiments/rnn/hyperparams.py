...
from gps.algorithm.policy_opt.lto_model import fully_connected_tf_network, fully_connected_tf_network_leaky_relu, fully_connected_tf_network_swish, recurrent_neural_network_multilayers, fcn4rnn
...
dataset_file = cur_dir + "/trainset_rnn.pkl"
...
EXP_DIR = BASE_DIR + '/../experiments/rnn/'
...
agent = {
    ...
    'obs_include': [CUR_LOC, PAST_OBJ_VAL_DELTAS, PAST_GRADS, CUR_GRAD, PAST_LOC_DELTAS],
...
algorithm['policy_opt'] = {
    'type': PolicyOpt,
    'network_model': recurrent_neural_network_multilayers,
    'iterations': 20, 
    'init_var': 0.01, 
    'batch_size': 25,
    'solver_type': 'adam',
    ...
    'network_params': {
        ...
        'dim_hidden': [6, 9, 9, 9, 6],
        'history_len': history_len,
        'param_dim': param_dim,
        'weights_prev': None,
        'biases_prev': None,
        'dim_hidden_output': [8, 8, 8],
        'weights_prev_output': None,
        'biases_prev_output': None,
    }
}
